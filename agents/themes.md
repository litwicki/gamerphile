...
Implement a theming system such that different themes can be selected in realtime and update the look and feel of the website.

Here's an example skeleton of a theme:
...
And the Layout tsx:
    ...
    ```typescript // For adding custom fonts with other frameworks, see:
    // https://tailwindcss.com/docs/font-family
    import type { Metadata } from "next";
    import { Inter, Georgia, JetBrains_Mono } from "next/font/google";
    import "./globals.css";
